    ...
    await prisma.booking.createMany({
      data: [
        ...
        },
        {
          ...
          email: "omar.semlali@yahoo.com",
          city: "طنجة",
          age: 21,
          confirmed: true,
          motive: "حضور مجالس الذكر والتزكية",
        },
        {
          eventId: upcomingEvent.id,
          fullName: "ياسين التازي",
          email: "yassine.tazi@outlook.com",
          city: "الرباط",
          age: 26,
          confirmed: true,
          motive: "المشاركة الفعالة ومناقشة قضايا الشباب",
        },
      ],
    });
