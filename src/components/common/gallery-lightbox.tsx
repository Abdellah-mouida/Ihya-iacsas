        ...
        <DialogContent className="max-w-3xl border-brass/30 bg-background/95 p-2 sm:max-w-3xl">
          ...
          <div className="relative overflow-hidden rounded-xl">
            ...
            <button
              ...
              className="glass absolute top-1/2 start-2 grid size-10 -translate-y-1/2 place-items-center rounded-full text-foreground transition hover:scale-110 hover:text-brass"
            >
            ...
            <button
              ...
              aria-label="next"
              onClick={() => go(dir === "rtl" ? -1 : 1)}
              className="glass absolute top-1/2 end-2 grid size-10 -translate-y-1/2 place-items-center rounded-full text-foreground transition hover:scale-110 hover:text-brass"
            >
