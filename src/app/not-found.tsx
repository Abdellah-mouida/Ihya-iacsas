    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-md mx-auto">
          يبدو أنك وصلت إلى صفحة غير موجودة. ربما تم نقلها أو حذفت.
        </p>
      </motion.div>
      ...
      <GlassmorphismCard>
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">
            لا تقلق، يمكنك العودة إلى الصفحة الرئيسية أو استكشاف المحتوى الآخر.
          </p>
          <motion.a
            href="/"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-block px-6 py-3 bg-brass text-white rounded-full font-medium hover:bg-brass/90 transition-colors"
          >
